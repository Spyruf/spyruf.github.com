            ...
            steps: [
                {
                    ...
                    placement: 'auto',
                    title: "First Time?",
                    content: "Create a playlist and invite your friends to listen with you"
                ...
                },
                {
                    ...
                    content: "Join an existing playlist and listen with your friends"
              }
                    ]
        });
            ...
            steps: [
                {
                    ...
                    placement: 'auto',
                    title: "Search",
                    content: "Simply type and the results will pop up below",
                    onNext: function () {
                        $scope.search = "Skizzy Mars"
                    }
                },
                {
                    element: "#middle",
